...
import com.trabajointegrador.trabajointegradordh.services.impl.DentistServiceImpl;
import com.trabajointegrador.trabajointegradordh.services.impl.PatientServiceImpl;
...
public class AppointmentDAOH2 implements IDao<Appointment> {
    ...
    private static final Logger logger = LogManager.getLogger(AppointmentDAOH2.class);
    ...
    PatientServiceImpl patientService = new PatientServiceImpl(new PatientDAOH2());
    DentistServiceImpl dentistservice = new DentistServiceImpl(new DentistDAOH2());
